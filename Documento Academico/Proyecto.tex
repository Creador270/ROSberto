...
<<<<<<< HEAD
    \item Reducir el tiempo de parametrización de los actuadores del robot humanoide Unitree G1 Edu y la carga de modelos en un 20\% de lo que se proponen en platafomas especializadas \cite{theconstruct2026humanoid}. 
=======
    \item Reducir el tiempo de parametrización de los actuadores del robot humanoide Unitree G1 Edu y la carga de modelos de 1 mes a un 4\% como se proponen en platafomas especializadas como theconstruct\cite{theconstruct2026humanoid}. 
>>>>>>> 3bdc793 (fuente del tiempo que toma desarrollar sobre modelos)
\end{itemize}
...
Esta perspectiva es particularmente importante para la democratización del aprendizaje robótico. Una revisión sobre LfD aplicada a ensamblaje industrial señala que este paradigma puede reducir la necesidad de conocimientos especializados de programación robótica y permitir que trabajadores no expertos enseñen comportamientos a los robots mediante demostraciones.\cite{HERNANDEZMORENO2024102658}
